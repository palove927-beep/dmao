...
8. 重要（層級段落合併規則）：若文章採用編號層級結構（例如主段落「2. ...」底下有子段落「a. ...」「b. ...」「c. ...」），處理步驟如下：
   步驟一：先將主段落與其所有子段落合併為一個完整區塊（從「2. ...」到最後一個子段落「c. ...」的結尾）
   步驟二：掃描整個區塊，找出所有被提及的公司/股票
   步驟三：每支被提及的股票都回傳一筆記錄，paragraph 為整個區塊的完整原文
   例如：若「2. ...NVIDIA...」底下有「a. ...台積電...」「b. ...NVIDIA...金居...」「c. ...NVIDIA...」，則 NVIDIA 的 paragraph 應包含 2.+a.+b.+c. 的完整原文，台積電和金居也各自回傳一筆，paragraph 同樣是 2.+a.+b.+c. 的完整原文。絕對不可以只回傳主段落「2. ...」而省略子段落
