      ...
      <main className="mx-auto max-w-6xl px-6 py-8">
        <div className="grid gap-6">
          {categories.map((cat) => (
            ...
            >
              <div className="border-b border-zinc-200 bg-zinc-100 px-5 py-3 dark:border-zinc-800 dark:bg-zinc-900">
                ...
                <table className="w-full text-left text-sm">
                  <thead>
                    <tr className="border-b border-zinc-100 text-xs text-zinc-500 dark:border-zinc-800 dark:text-zinc-400">
                      <th className="px-5 py-2 font-medium">代碼</th>
                      <th className="px-5 py-2 font-medium">股票代號</th>
                      <th className="px-5 py-2 font-medium">名稱</th>
                    </tr>
                  </thead>
                  <tbody>
                    {cat.stocks.map((stock) => (
                      <tr
                        key={stock.code}
                        className="border-b border-zinc-50 transition-colors hover:bg-zinc-50 dark:border-zinc-900 dark:hover:bg-zinc-900"
                      >
                        <td className="px-5 py-2.5 font-mono text-xs text-zinc-400">
                          {stock.code}
                        </td>
                        <td className="px-5 py-2.5 font-mono font-semibold text-black dark:text-white">
                          {stock.ticker}
                        </td>
