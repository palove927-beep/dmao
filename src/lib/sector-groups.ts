    ...
    groups: [
      {
        ...
        stocks: [
          ...
          { ticker: "3362", name: "先進光", market: "tpex", temp: "hot" },
          { ticker: "3504", name: "揚明光", temp: "hot" },
          { ticker: "6668", name: "中揚光", temp: "hot" },
          { ticker: "6517", name: "保勝光學", market: "tpex", temp: "hot" },
      ...
      },
      {
        ...
        label: "散熱",
        stocks: [
          { ticker: "3653", name: "健策", temp: "warm" },
          { ticker: "3017", name: "奇鋐", temp: "warm" },
    ...
    groups: [
      {
        ...
        label: "記憶體",
        stocks: [
          { ticker: "2408", name: "南亞科", temp: "warm" },
          { ticker: "3006", name: "晶豪科", temp: "warm" },
          { ticker: "5351", name: "鈺創", market: "tpex", temp: "warm" },
      ...
      },
      {
        ...
        label: "運輸",
        stocks: [
          { ticker: "2603", name: "長榮", temp: "warm" },
          { ticker: "2609", name: "陽明", temp: "warm" },
          { ticker: "2615", name: "萬海", temp: "warm" },
          { ticker: "2637", name: "慧洋-KY", temp: "warm" },
          { ticker: "2606", name: "裕民", temp: "warm" },
      ...
      },
      {
        ...
        label: "電腦與週邊設備",
        stocks: [
          { ticker: "2301", name: "光寶科", temp: "warm" },
          { ticker: "7711", name: "永擎", temp: "warm" },
          { ticker: "2357", name: "華碩", temp: "warm" },
      ...
      },
      {
        ...
        label: "CCL、FCCL",
        stocks: [
          { ticker: "8039", name: "台虹", temp: "warm" },
          { ticker: "4939", name: "亞電", market: "tpex", temp: "warm" },
          { ticker: "6213", name: "聯茂", temp: "warm" },
      ...
      },
      {
        ...
        label: "光通訊",
        stocks: [
          { ticker: "3081", name: "聯亞", market: "tpex", temp: "warm" },
          { ticker: "3234", name: "光環", market: "tpex", temp: "warm" },
          { ticker: "2455", name: "全新", temp: "warm" },
    ...
    groups: [
      {
        ...
        label: "PCB",
        stocks: [
          { ticker: "3037", name: "欣興", temp: "warm" },
          { ticker: "8046", name: "南電", temp: "warm" },
          { ticker: "3189", name: "景碩", temp: "warm" },
      ...
      },
      {
        ...
        label: "電機",
        stocks: [
          { ticker: "1590", name: "亞德客-KY", temp: "warm" },
      ...
      },
      {
        ...
        label: "個股表現",
        stocks: [
          { ticker: "2881", name: "富邦金", temp: "warm" },
          { ticker: "6782", name: "視陽", temp: "warm" },
          { ticker: "1815", name: "富喬", market: "tpex", temp: "warm" },
          { ticker: "2351", name: "順德", temp: "warm" },
          { ticker: "6805", name: "富世達", temp: "warm" },
