...
export const scanStocks: ScanStock[] = [
  ...
  { ticker: "7856",       name: "漢測",                   aliases: ["漢測科技"] },
  ...
  { ticker: "2388", name: "威盛" },
  { ticker: "2392", name: "正崴" },
  { ticker: "2449", name: "京元電子",  aliases: ["京元電"] },
  { ticker: "2451", name: "創見" },
  { ticker: "2458", name: "義隆" },
  ...
  { ticker: "009150.KS", name: "三星電機(SEMCO)", aliases: ["Samsung Electro-Mechanics", "三星電機", "SEMCO"] },
