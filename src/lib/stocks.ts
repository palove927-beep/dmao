...
export const categories: Category[] = [
  ...
  },
  {
    ...
    stocks: [
      ...
      { code: "K6", ticker: "3533", name: "嘉澤" },
      { code: "K7", ticker: "6584", name: "南俊國際" },
      { code: "K8", ticker: "6805", name: "富世達" },
      { code: "K9", ticker: "8210", name: "勤誠" },
    ],
  },
  {
    id: "L",
  ...
  },
  {
    ...
    stocks: [
      ...
      { code: "U3", ticker: "9802", name: "鈺齊-KY" },
      { code: "U4", ticker: "9938", name: "百和" },
    ],
  },
  {
    id: "V",
    label: "海外科技巨頭",
    stocks: [
      { code: "V1", ticker: "MU", name: "Micron", aliases: ["美光"] },
      { code: "V2", ticker: "INTC", name: "Intel", aliases: ["英特爾"] },
      { code: "V3", ticker: "AMD", name: "AMD", aliases: ["超微"] },
      { code: "V4", ticker: "NVDA", name: "NVIDIA", aliases: ["輝達", "英偉達"] },
      { code: "V5", ticker: "AVGO", name: "Broadcom", aliases: ["博通"] },
      { code: "V6", ticker: "IFX", name: "Infineon", aliases: ["英飛凌"] },
      { code: "V7", ticker: "QCOM", name: "Qualcomm", aliases: ["高通"] },
      { code: "V8", ticker: "AAPL", name: "Apple", aliases: ["蘋果"] },
      { code: "V9", ticker: "ASML", name: "ASML", aliases: ["艾司摩爾"] },
      { code: "V10", ticker: "TSLA", name: "Tesla", aliases: ["特斯拉"] },
      { code: "V11", ticker: "BA", name: "Boeing", aliases: ["波音"] },
      { code: "V12", ticker: "4062.T", name: "Ibiden" },
      { code: "V13", ticker: "005930.KS", name: "Samsung", aliases: ["三星"] },
      { code: "V14", ticker: "000660.KS", name: "SK Hynix", aliases: ["海力士"] },
      { code: "V15", ticker: "COHR", name: "Coherent", aliases: ["貳陸"] },
      { code: "V16", ticker: "LITE", name: "Lumentum" },
      { code: "V17", ticker: "CRDO", name: "Credo", aliases: ["Credo Technology"] },
      { code: "V18", ticker: "META", name: "Meta", aliases: ["Meta Platforms", "Facebook"] },
      { code: "V19", ticker: "NXPI", name: "NXP Semiconductors", aliases: ["NXP", "恩智浦"] },
    ],
  },
];
