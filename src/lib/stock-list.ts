...
export const categories: Category[] = [
  ...
  },
  {
    ...
    stocks: [
      ...
      { code: "K05", ticker: "3533", name: "嘉澤", market: "tpex" },
      { code: "K06", ticker: "4931", name: "新盛力", market: "tpex" },
      { code: "K07", ticker: "6584", name: "南俊國際", market: "tpex" },
      { code: "K08", ticker: "6805", name: "富世達", market: "tpex" },
      { code: "K09", ticker: "8210", name: "勤誠", market: "tpex" },
    ],
  },
  {
    id: "L",
  ...
  },
  {
    ...
    stocks: [
      ...
      { code: "N3", ticker: "3715", name: "定穎投控", market: "tpex" },
      { code: "N4", ticker: "4958", name: "臻鼎-KY" },
      { code: "N5", ticker: "6191", name: "精成科", market: "tpex" },
    ],
  },
  {
    id: "O",
