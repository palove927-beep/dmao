...
export const categories: Category[] = [
  ...
  },
  {
    ...
    stocks: [
      ...
      { code: "E4", ticker: "6488", name: "環球晶", market: "tpex" },
    ],
  },
  {
    id: "F",
  ...
  },
  {
    ...
    stocks: [
      ...
      { code: "G02", ticker: "2493", name: "揚博" },
      { code: "G03", ticker: "3131", name: "弘塑", market: "tpex" },
      { code: "G04", ticker: "3455", name: "由田", market: "tpex" },
      { code: "G05", ticker: "3485", name: "敘豐", market: "tpex" },
      { code: "G06", ticker: "3563", name: "牧德" },
      { code: "G07", ticker: "3583", name: "辛耘" },
      { code: "G08", ticker: "6438", name: "迅得" },
      { code: "G09", ticker: "6664", name: "群翊", market: "tpex" },
      { code: "G10", ticker: "6937", name: "天虹", market: "tpex" },
      { code: "G11", ticker: "6953", name: "家碩", market: "tpex" },
      { code: "G12", ticker: "7795", name: "長廣" },
      { code: "G13", ticker: "7822", name: "倍利科", market: "tpex" },
      { code: "G14", ticker: "7853", name: "政美應用", market: "tpex" },
      { code: "G15", ticker: "8027", name: "鈦昇", market: "tpex" },
    ],
  },
  {
    id: "H",
    ...
    stocks: [
      ...
      { code: "H4", ticker: "4991", name: "環宇-KY", market: "tpex" },
      { code: "H5", ticker: "8086", name: "宏捷科", market: "tpex" },
    ],
  },
  {
    id: "I",
    ...
    stocks: [
      ...
      { code: "I4", ticker: "3260", name: "威剛", market: "tpex" },
  ...
  },
  {
    ...
    stocks: [
      ...
      { code: "K05", ticker: "3533", name: "嘉澤" },
      { code: "K06", ticker: "4931", name: "新盛力", market: "tpex" },
      { code: "K07", ticker: "6584", name: "南俊國際", market: "tpex" },
      { code: "K08", ticker: "6805", name: "富世達" },
      { code: "K09", ticker: "7788", name: "松川精密" },
  ...
  },
  {
    ...
    label: "銅箔基板",
    stocks: [
      { code: "M1", ticker: "2383", name: "台光電" },
      { code: "M2", ticker: "6274", name: "台燿", market: "tpex" },
      { code: "M3", ticker: "8358", name: "金居", market: "tpex" },
    ],
  },
  {
    id: "N",
    label: "PCB",
    stocks: [
      { code: "N1", ticker: "2313", name: "華通" },
      { code: "N2", ticker: "3037", name: "欣興" },
      { code: "N3", ticker: "3715", name: "定穎投控" },
      { code: "N4", ticker: "4958", name: "臻鼎-KY" },
      { code: "N5", ticker: "6191", name: "精成科" },
    ],
  },
  {
    id: "O",
    ...
    stocks: [
      ...
      { code: "O3", ticker: "5425", name: "台半", market: "tpex" },
      { code: "O4", ticker: "6271", name: "同欣電" },
      { code: "O5", ticker: "6719", name: "力智" },
      { code: "O6", ticker: "7712", name: "博盛半導體", market: "tpex" },
      { code: "O7", ticker: "8255", name: "朋程", market: "tpex" },
      { code: "O8", ticker: "8261", name: "富鼎" },
    ],
  },
  {
    id: "P",
