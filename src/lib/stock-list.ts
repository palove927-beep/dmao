...
export const categories: Category[] = [
  ...
  },
  {
    ...
    stocks: [
      ...
      { code: "G06", ticker: "6664", name: "群翊" },
      { code: "G07", ticker: "6937", name: "天虹" },
      { code: "G08", ticker: "6953", name: "家碩" },
      { code: "G09", ticker: "7822", name: "倍利科" },
  ...
  },
  {
    ...
    stocks: [
      ...
      { code: "M2", ticker: "6274", name: "台燿", aliases: ["Taiflex"] },
      { code: "M3", ticker: "8358", name: "金居", aliases: ["Co-Tech"] },
    ],
  },
  {
    id: "N",
    ...
    stocks: [
      ...
      { code: "N3", ticker: "3715", name: "定穎投控", aliases: ["定穎"] },
      { code: "N4", ticker: "4958", name: "臻鼎-KY", aliases: ["臻鼎", "ZDT"] },
      { code: "N5", ticker: "6191", name: "精成科", aliases: ["GCE"] },
    ],
  },
  {
    id: "O",
