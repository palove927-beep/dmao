...
export const categories: Category[] = [
  ...
  },
  {
    ...
    stocks: [
      ...
      { code: "G04", ticker: "3563", name: "牧德" },
      { code: "G05", ticker: "3583", name: "辛耘" },
      { code: "G06", ticker: "6438", name: "迅得" },
      { code: "G07", ticker: "6664", name: "群翊", market: "tpex" },
      { code: "G08", ticker: "6937", name: "天虹", market: "tpex" },
      { code: "G09", ticker: "6953", name: "家碩", market: "tpex" },
      { code: "G10", ticker: "7822", name: "倍利科", market: "tpex" },
      { code: "G11", ticker: "7853", name: "政美應用", market: "tpex" },
      { code: "G12", ticker: "8027", name: "鈦昇", market: "tpex" },
    ],
  },
  {
    id: "H",
