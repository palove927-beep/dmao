...
export const categories: Category[] = [
  {
    ...
    stocks: [
      ...
      { code: "A3", ticker: "5274", name: "信驊", aliases: ["Aspeed"], market: "tpex" },
    ],
  },
  {
    id: "B",
    ...
    stocks: [
      ...
      { code: "B3", ticker: "5347", name: "世界", aliases: ["VIS"], market: "tpex" },
    ],
  },
  {
    id: "C",
    ...
    stocks: [
      ...
      { code: "C2", ticker: "6239", name: "力成", aliases: ["PTI"], market: "tpex" },
      { code: "C3", ticker: "6257", name: "矽格", aliases: ["Sigurd"], market: "tpex" },
    ],
  },
  {
    id: "D",
  ...
  },
  {
    ...
    stocks: [
      ...
      { code: "E3", ticker: "3680", name: "家登", aliases: ["Gudeng"], market: "tpex" },
  ...
  },
  {
    ...
    stocks: [
      ...
      { code: "H5", ticker: "4991", name: "環宇-KY", aliases: ["環宇"], market: "tpex" },
  ...
  },
  {
    ...
    stocks: [
      ...
      { code: "I5", ticker: "6531", name: "愛普", aliases: ["Ap Memory", "ApMemory"], market: "tpex" },
      { code: "I6", ticker: "8299", name: "群聯", aliases: ["Phison"], market: "tpex" },
    ],
  },
  {
    id: "J",
  ...
  },
  {
    ...
    stocks: [
      ...
      { code: "K04", ticker: "3017", name: "奇鋐", aliases: ["Asia Vital", "AVC"], market: "tpex" },
  ...
  },
  {
    ...
    stocks: [
      ...
      { code: "L5", ticker: "8042", name: "金山電", market: "tpex" },
    ],
  },
  {
    id: "M",
    label: "銅箔基板",
    stocks: [
      { code: "M1", ticker: "2383", name: "台光電", aliases: ["EMC", "台光"] },
      { code: "M2", ticker: "6274", name: "台燿", aliases: ["Taiflex"], market: "tpex" },
      { code: "M3", ticker: "8358", name: "金居", aliases: ["Co-Tech"], market: "tpex" },
    ],
  },
  {
    id: "N",
    label: "PCB",
    stocks: [
      { code: "N1", ticker: "2313", name: "華通", aliases: ["Compeq"] },
      { code: "N2", ticker: "3037", name: "欣興", aliases: ["Unimicron"] },
      { code: "N3", ticker: "3715", name: "定穎投控", aliases: ["定穎"], market: "tpex" },
      { code: "N4", ticker: "4958", name: "臻鼎-KY", aliases: ["臻鼎", "ZDT"] },
      { code: "N5", ticker: "6191", name: "精成科", aliases: ["GCE"], market: "tpex" },
    ],
  },
  {
    id: "O",
    ...
    stocks: [
      ...
      { code: "O2", ticker: "3675", name: "德微", market: "tpex" },
      { code: "O3", ticker: "5425", name: "台半", aliases: ["TSC"], market: "tpex" },
      { code: "O4", ticker: "6271", name: "同欣電", aliases: ["Tong Hsing"], market: "tpex" },
      { code: "O5", ticker: "8255", name: "朋程", aliases: ["PanJit"], market: "tpex" },
      { code: "O6", ticker: "8261", name: "富鼎", market: "tpex" },
    ],
  },
  {
    id: "P",
  ...
  },
  {
    ...
    stocks: [
      ...
      { code: "Q2", ticker: "5388", name: "中磊", market: "tpex" },
      { code: "Q3", ticker: "6285", name: "啟碁", market: "tpex" },
    ],
  },
  {
    id: "R",
    ...
    stocks: [
      ...
      { code: "R2", ticker: "5306", name: "桂盟", market: "tpex" },
    ],
  },
  {
    id: "S",
    label: "循環經濟",
    stocks: [
      { code: "S1", ticker: "6894", name: "衛司特", market: "tpex" },
      { code: "S2", ticker: "8936", name: "國統", market: "tpex" },
    ],
  },
  {
    id: "T",
    label: "紡織製鞋",
    stocks: [
      { code: "T1", ticker: "6768", name: "志強-KY", market: "tpex" },
      { code: "T2", ticker: "6890", name: "來億-KY", market: "tpex" },
      { code: "T3", ticker: "9938", name: "百和" },
    ],
  },
];
